...
const SOCIAL_LINKS = [
  ...
  },
  {
    id:    "footer-instagram",
    label: "Instagram",
    href:  "https://www.instagram.com/umangpandey_1?stkn=Ymxndzg0eGQwNXV3",
    icon:  (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <div className="section-wrapper">
        ...
        >
          ...
          <div style={{ maxWidth: 280 }}>
            ...
            >
              Computer Science student from Noida, India — building data pipelines, dashboards, and software solutions.
            </p>
          </div>
